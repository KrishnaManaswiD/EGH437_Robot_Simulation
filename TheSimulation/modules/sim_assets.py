...
class SimAssets(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        """
        super(SimAssets, self).__init__(*args, **kwargs)
    ...
    def load_assets(self):
        ...
        # load images
        self.create_image_asset("img_robot", "images/robot.png", True)
        self.create_image_asset("img_light", "images/light.png", True)
        self.create_image_asset("img_light_sensor", "images/light_sensor.png", True)
        self.create_image_asset("img_lidar", "images/lidar.png", True)
